...
export const fa: Dictionary = {
  onboarding: {
    ...
    guide1:
      ...
      `با 《🎲جستجوی شانسی》 بصورت نامحدود و  بدون نیاز به سکه چت کن !\n\n` +
      `${textEmoji("P3", "3️⃣")} چجوری دوستامو دعوت کنم و #سکه بدست بیارم؟\n` +
  ...
  matching: {
    ...
    chatEndedByPartner: (anonId: string) =>
      `🎌 چت شما با /${anonId} توسط مخاطب شما قطع شد.\n\n` +
      `برای گزارش عدم رعایت قوانین (/ghavanin) می توانید با لمس 《 🚫 گزارش کاربر 》 در پروفایل، کاربر را گزارش کنید.`,

    chatCashback: "💰 تعداد 1 سکه به دلیل ناموفق بودن چت به حساب شما برگشت!",

    profileViewNotification:
      "پیام ربات 👇\n\n" +
      "مخاطب شما  پروفایلِ نوا  شما را مشاهده کرد.\n\n" +
      "⚠️ توجه: پروفایل نوا اطلاعاتی است که در بخش پروفایل ربات ثبت کرده اید!",
  },
