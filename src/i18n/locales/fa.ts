...
export const fa: Dictionary = {
  onboarding: {
    ...
    guide1:
      ...
      `کافیه /link رو بزنی و لینک مخصوص خودتو دریافت کنی ، با معرفی هرکدوم از دوستات ۲۰ تا رلیک کوین بگیری 😍\n\n` +
    ...
    completionMessage:
      ...
      `به خانواده بزرگ نوا خوش اومدی بهت توصیه میکنم اول از همه با لمس کردن دکمه راهنما  با ربات آشنا شی`,
